...
final class GaleryViewController: UIViewController {
    ...
    @objc private func continueButtonTapped() {
        navigationController?.pushViewController(HelpUsViewController(), animated: true)
    }
}

//MARK: - Extensions
private extension GaleryViewController {
    ...
    func setupViews() {
        ...
        mainLabel.text = "Discover the world of AI-inspired creations"
